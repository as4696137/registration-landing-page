...
const Details_section = () => {
  return (
    <section id="details" className="relative w-full overflow-hidden bg-[#0000ff]">
      <div className="relative z-10 mx-auto flex w-fit flex-col px-40 pb-40 pt-[88px] max-[1440px]:w-full max-[1440px]:px-[84px] max-[1440px]:pb-40 max-[1440px]:pt-[95px] max-[786px]:px-2 max-[786px]:pb-20 max-[786px]:pt-10">
        <h2 className="title-shadow-lg stroke-black mb-16 font-display text-[80px] leading-[120%] text-white max-[1440px]:self-center max-[1440px]:text-[65px] max-[1440px]:title-shadow-sm max-[786px]:text-5xl">
          報名詳情
        </h2>

        <div className="mb-10 flex gap-x-5 max-[1440px]:w-full max-[1440px]:flex-col max-[1440px]:gap-y-5 max-[786px]:mx-4 max-[786px]:mb-0 max-[786px]:px-6 max-[786px]:py-10">
          {renderInfoCard(
            "參賽資格：",
        ...
        <div className="flex w-[1120px] flex-col border border-black bg-white p-10 drop-shadow-[0_10px_0_rgba(0,0,0,0.25)] max-[1440px]:w-full max-[1440px]:px-[50px] max-[1440px]:py-6 max-[786px]:px-6 max-[786px]:py-4">
          <p className="text-2xl font-bold leading-[160%]">報名及交件流程：</p>

          <div className="px-6 max-[1440px]:px-4">
            {renderStep(
              "01",
          ...
          <button className="mt-6 flex items-center self-center bg-[#0000ff] px-6 pb-3.5 pt-3 text-white drop-shadow-[0_5px_0_rgba(0,0,0,0.25)] max-[1440px]:text-base">
            交件策略單參考{" "}
            <span className="pl-2">
        ...
        <div className="mt-10 flex w-[1120px] gap-x-5 max-[1440px]:w-full max-[1440px]:flex-col max-[1440px]:gap-y-[30px] max-[1440px]:px-[25px] max-[786px]:gap-y-4 max-[786px]:px-4">
          <Link
            to="/register"
