...
const InfoC_section = () => {
  return (
    <section className="relative w-full overflow-hidden bg-[#9bf3e0]">
      <div className="relative z-10 mx-auto flex h-fit w-fit flex-col items-center pb-[120px] pt-[88px] max-[786px]:m-0 max-[786px]:w-full">
        <div className="mb-20 flex items-center max-[1440px]:mb-[94px] max-[1440px]:flex-col max-[1440px]:items-start max-[1440px]:gap-y-4 max-[786px]:mb-[78px] max-[786px]:px-8">
        ...
        <div className="relative mb-[91px] max-[1440px]:mb-[85px] max-[1440px]:w-fit max-[786px]:mb-14 max-[786px]:w-full max-[786px]:px-2">
          <p className="absolute left-1/2 top-[-56px] z-10 flex -translate-x-1/2 whitespace-nowrap border border-black bg-[#ffff41] px-10 py-4 font-display text-[40px] leading-[120%] drop-shadow-[0_10px_0_rgba(0,0,0,0.25)] max-[1440px]:top-[-54px] max-[1440px]:flex-col max-[1440px]:px-[104px] max-[1440px]:text-[32px] max-[786px]:px-4">
            <span>各獎項首獎獎金</span>
            <span>NT$20,000</span>
          </p>

          <div className="flex h-fit w-fit gap-x-[63px] border border-black bg-white px-16 py-12 drop-shadow-[0_10px_0_rgba(0,0,0,1)] max-[1440px]:w-[600px] max-[1440px]:flex-col max-[1440px]:gap-y-6 max-[1440px]:px-6 max-[1440px]:pb-6 max-[1440px]:pt-20 max-[786px]:w-full">
            {renderRewardCard(A, "志祺七七", "平均觀看超過十萬", "單集一分鐘曝光介紹得獎作品")}
            {renderRewardCard(B, "敏迪國際選讀", "每集首週可達到17萬播放", "專訪一集介紹得獎作品及團隊")}
          </div>
        </div>

        <div className="relative max-[786px]:w-full max-[786px]:px-2">
          <p className="absolute left-[-40px] top-[-30px] z-10 whitespace-nowrap border border-black bg-[#9bf3e0] px-4 py-2 text-2xl font-bold leading-[120%] drop-shadow-[0_10px_0_rgba(0,0,0,0.25)] max-[1440px]:top-[-24px] max-[1440px]:text-xl max-[1440px]:drop-shadow-[0_5px_0_rgba(0,0,0,0.25)] max-[786px]:left-1/2 max-[786px]:-translate-x-1/2">
            2021年流量獎品
          </p>

          <div className="flex h-fit w-fit gap-x-10 border border-black bg-[#9bf3e0] px-10 py-12 drop-shadow-[0_10px_0_rgba(0,0,0,0.25)] max-[1440px]:flex-col max-[1440px]:gap-y-[26px] max-[1440px]:px-[142px] max-[1440px]:py-10 max-[786px]:w-full max-[786px]:px-6 max-[786px]:pb-6">
...
const renderRewardCard = (
  ...
  <div className="flex items-center max-[1440px]:flex-col" key={title}>
