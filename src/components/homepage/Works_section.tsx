...
const Works_section = () => {
  ...
  return (
    <MotionSection id="works" className="relative w-full overflow-hidden bg-[#4af864]">
      <MotionGroup className="relative z-10 mx-auto flex h-fit w-full flex-col px-40 pb-[114px] pt-[88px] max-[1440px]:px-40 max-[1440px]:pb-[188px] max-[1440px]:pt-[54px] max-[786px]:px-0 max-[786px]:pb-[168px] max-[786px]:pt-10">
        <MotionItem>
        ...
        <MotionGroup className="mt-16 flex w-fit flex-col self-center max-[1440px]:mt-[35px] max-[786px]:mt-6 max-[786px]:w-full">
          <MotionItem className="self-end max-[1440px]:self-center max-[786px]:w-full max-[786px]:px-6">
            <CustomSelect
              options={options}
